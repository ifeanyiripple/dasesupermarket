...
import HorizontalFoodCard from "@/components/Horizontalfoodcard"   // ← NEW
...
// ── NEW: Local Favourites horizontal strip ─────────────────────────────────────
...
export default function HomeTabs({ foods, supermarketContent, rooms }: Props) {
  ...
  // ── NEW: split local favourites out ──────────────────────────────────────
        ...
        >
          ...
          {activeTab === "restaurant" && (
            <div className="px-2 md:px-6 pb-6">
              ...
              {/* ── NEW: Local Favourites strip (always shown first) ───────── */}
